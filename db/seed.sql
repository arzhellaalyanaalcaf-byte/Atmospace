...
(32, 'pengertian', '', 'Kata "Meteoron" dari Bahasa Yunani berarti?', 'Bintang jatuh', 'Fenomena di udara', 'Perubahan suhu', 'B'),
...
(36, 'awan', '', 'Awan yang berada pada ketinggian lebih dari 6 km (≥ 6 km) dikategorikan sebagai awan…', 'Menengah', 'Tinggi (High Level)', 'Rendah', 'B'),
...
(50, 'fenomena', '', 'Proses pembentukan hujan es terjadi ketika butiran air mengalami siklus naik/turun berulang kali melalui lapisan bersuhu di bawah nol yang didorong oleh?', 'Angin Darat', 'Updraft (Arus Naik) yang sangat kuat', 'Pendinginan Radiatif', 'B'),
...
(54, 'parameter', '', 'Komponen vektor angin yang menggambarkan pergerakan angin dalam arah barat/timur adalah?', 'Komponen v (Angin Meridional)', 'Komponen u (Angin Zonal)', 'Komponen w (Angin Vertikal)', 'B'),
...
(62, 'general', 'easy', 'Awan cumulus biasanya identik dengan kondisi cuaca?', 'Gumpalan putih rendah → cuaca relatif cerah hingga berawan konvektif', 'Lapisan tipis di ketinggian tinggi → indikasi hujan segera', 'Awan gelap tebal → hujan stabil lama', 'A'),
...
(69, 'general', 'medium', 'Ketinggian standar pengukuran suhu udara menurut WMO adalah?', '0 meter', '1.25 sampai 2 meter dari permukaan tanah', '10 meter', 'B'),
...
(73, 'general', 'hard', 'Jika pagi terlihat altocumulus yang luas, interpretasi yang paling mungkin adalah?', 'Atmosfer sangat stabil', 'Potensi konveksi meningkat → kemungkinan badai sore', 'Tanda pasti hujan ekstrem 1 jam lagi', 'B'),
